...
import { FETCH_COMMENTS, ADD_COMMENTS, DELETE_COMMENT, DELETE_COMMENTS, FETCH_SUBMISSION } from '../constants/actionTypes.js';
...
export const fetchSubmission = (id) => async (dispatch) => {
  try {
    ...
    dispatch({ type: FETCH_SUBMISSION, payload: data.submissions });
