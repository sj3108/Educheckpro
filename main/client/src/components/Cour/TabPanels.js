                ...
                isProfesseur ? <Box sx={{ width: '100%' }}>
                    <Box sx={{ borderBottom: 1, borderColor: 'divider' }}>
                        <Tabs value={value} onChange={handleChange} aria-label="gestion cours">
                            <Tab icon={<TopicIcon fontSize='large' />} label="Class" sx={{ minWidth: "50%", fontFamily: 'Nunito' }} />
                            <Tab icon={<AddRoundedIcon fontSize='large' />} label="Add Assignment" sx={{ minWidth: "50%", fontFamily: 'Nunito' }} />
